...
<head>
    ...
    <meta name="keywords" content="http://sjsm.edu.ph, sjsm.edu.ph, sjsm, sjsofmactan, Catholic School, Religious School, St. Joseph's School of Mactan, St. Joseph, Josephian, SFIC, St. Francis, St. Francis of Assissi, Franciscan school, Franciscan Sisters, St. Joseph's School - Mactan, Mactan, Lapu-Lapu City, Acacia Road, Mactan, Lapu-Lapu City, Cebu 6015, agnes labitoria, editha radam, mercedes salud, mactan school, sjcqc">
...
<?php get_template_part('nav-menu'); ?> 
    ...
    <?php //include("parallaxSlider-pages.php") ?>
    <?php //get_template_part('connect/parallaxSlider', 'pages'); ?>
